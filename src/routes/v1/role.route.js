...
router
  ...
  router
  .route('/search-filter')
  .get(validate(auth(), roleValidation.searchFilter), roleController.searchFilter);
router
  .route('/:id')
  ...
  .get(validate(auth(), roleValidation.getPermissions), roleController.getPermissions);
